...
from vldet.data.custom_build_augmentation import build_custom_augmentation
from vldet.data.custom_dataset_dataloader import  build_custom_train_loader
from vldet.data.custom_dataset_mapper import CustomDatasetMapper, DetrDatasetMapper
from vldet.custom_solver import build_custom_optimizer
from vldet.evaluation.oideval import OIDEvaluator
from vldet.evaluation.custom_coco_eval import CustomCOCOEvaluator
from vldet.modeling.utils import reset_cls_test
...
def do_test(cfg, model):
    ...
    for d, dataset_name in enumerate(cfg.DATASETS.TEST):
        ...
        if evaluator_type == "lvis" or cfg.GEN_PSEDO_LABELS:
            ...
            if dataset_name == 'coco_generalized_zeroshot_val' or dataset_name == 'coco_generalized_del_val':
