...
logger = logging.getLogger('detectron2.vlpart.data.datasets.lvis_v1')

__all__ = ["custom_load_lvis_json", "custom_register_lvis_instances"]


def custom_register_lvis_instances(name, metadata, json_file, image_root, random_image=False):
    """
    """
...
def custom_load_lvis_json(json_file, image_root, dataset_name=None, random_image=False):
    '''
    Modifications:
      use `file_name`
